...
connect_debug_port u_ila_1/probe1 [get_nets [list {VGA_B_OBUF[0]} {VGA_B_OBUF[1]} {VGA_B_OBUF[2]} {VGA_B_OBUF[3]}]]
...
connect_debug_port u_ila_1/probe3 [get_nets [list {VGA_G_OBUF[0]} {VGA_G_OBUF[1]} {VGA_G_OBUF[2]} {VGA_G_OBUF[3]}]]
...
connect_debug_port u_ila_1/probe5 [get_nets [list clk_25_175MHZ]]
...
connect_debug_port u_ila_2/clk [get_nets [list clk_wiz_0_inst/inst/CLKOUT_24MHZ]]
...
connect_debug_port u_ila_2/probe0 [get_nets [list CAM_XCLK_OBUF]]
...
connect_debug_port u_ila_3/probe2 [get_nets [list IIC_0_0_scl_t]]
...
connect_debug_port u_ila_3/probe3 [get_nets [list IIC_0_0_sda_i]]
...
connect_debug_port u_ila_3/probe4 [get_nets [list IIC_0_0_sda_o]]
...
connect_debug_port u_ila_3/probe5 [get_nets [list IIC_0_0_sda_t]]
...
connect_debug_port u_ila_4/clk [get_nets [list clk_wiz_0_inst/inst/clkfbout_buf_clk_wiz_0]]
...
connect_debug_port u_ila_4/probe0 [get_nets [list RST_IBUF]]
