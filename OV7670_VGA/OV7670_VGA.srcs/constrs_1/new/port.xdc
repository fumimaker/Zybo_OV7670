...
connect_debug_port u_ila_0/probe2 [get_nets [list {data_IBUF[1]} {data_IBUF[2]} {data_IBUF[3]} {data_IBUF[4]} {data_IBUF[7]}]]
create_debug_port u_ila_0 probe
...
set_property MARK_DEBUG false [get_nets {data_IBUF[1]}]
set_property MARK_DEBUG false [get_nets {data_IBUF[2]}]
set_property MARK_DEBUG false [get_nets {data_IBUF[3]}]
set_property MARK_DEBUG false [get_nets {data_IBUF[4]}]
set_property MARK_DEBUG false [get_nets {data_IBUF[7]}]
