...
HD_PWD='C:/Github/Zybo_OV7670/ov7670_capture/ov7670_capture.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov7670_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov7670_test.tcl -notrace
